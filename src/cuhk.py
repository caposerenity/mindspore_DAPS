...
PATH_DATASET = r'/data/dataset/CUHK'
PATH_ANNO = r'/data/dataset/CUHK/annotations'
...
class CUHKDataset:
    ...
    def __init__(self,
        ...
        if query_test_pipeline is None:
            ...
            self.query_test_pipeline = CustomCompose(query_test_pipeline)
